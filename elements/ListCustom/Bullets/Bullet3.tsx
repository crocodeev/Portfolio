...
const Bullet3 = forwardRef(function Bullet({ strokeColor }: TBullet, ref: any ) {
  ...
  if(ref){
    ...
    return(
      ...
      <svg  style={{ transition: "rotate 0.25s" }} ref={arrow} width="15" height="26" viewBox="0 0 15 26" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path 
